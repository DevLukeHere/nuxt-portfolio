<template>
  ...
  <p class="text-lg">
    ...
    been
    submitted to
    <a href="https://uses.tech/" aria-label="uses.tech" rel="noopener noreferrer">uses.tech</a>.
  </p>
  ...
  <ul class="list-disc">
    <li class="ml-8 py-1"><a href="https://code.visualstudio.com/" aria-label="Visual Studio Code"
    ...
    <li class="ml-8 py-1">
      ...
      <a href="https://marketplace.visualstudio.com/items?itemName=RobbOwen.synthwave-vscode"
        aria-label="Synthwave 84 by Robb Owen" rel="noopener noreferrer">Synthwave 84</a> by Robb Owen.
    </li>
    <li class="ml-8 py-1">
      Font is
      <a href="https://sourcefoundry.org/hack/" aria-label="Hack Font" rel="noopener noreferrer">Hack</a>
    </li>
    <li class="ml-8 py-1"><a href="https://www.iterm2.com/" aria-label="iTerm" rel="noopener noreferrer">iTerm2</a> is my
      Terminal
    </li>
  </ul>
