...
<template>
  <section>
    <h1 class="text-5xl font-bold mt-20">👋🏻 Hello, I'm Luke!</h1>
  ...
  <section class="flex flex-col md:flex-row">
    <div class="md:w-3/4">
      ...
      <p class="text-lg py-2">
        I am a Web Developer living just outside of one of my favorite places in the world, Petaling Jaya, Selangor. I am
        a
      ...
      <p class="text-lg py-2">
        I have been doing web development for over 3 years now and I use my knowledge, passion, and influence to help
        other
        developers achieve their goals.
      </p>
      <p class="text-lg py-2">
        In my personal life I am an avid gamer, where I primarily game on my PlayStation 5 or computer. I enjoy
        reading,
